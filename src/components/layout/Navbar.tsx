    ...
    <>
      ...
      <div className="pt-16 flex">
        {(isSidebarOpen || !isMobile) && (
          <aside className="fixed top-16 left-0 w-64 h-[calc(100vh-4rem)] border-r bg-secondary text-secondary-foreground shadow-sm z-20">
        ...
        {/* Main content container with proper margin to prevent overlap */}
        <div 
          className={cn(
